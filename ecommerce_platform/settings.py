...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-^tdcz-7)i+@ol91m_xe$*f9&w)wpr6^_ylf)$(8su=u)ha3+x+')
...
# Redis Cache Configuration (Optional - for Docker)
# For local development without Redis, comment this out
# CACHES = {
#     'default': {
...
# Local development cache (no Redis required)
CACHES = {
    'default': {
